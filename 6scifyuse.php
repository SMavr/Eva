...
<?php
    ...
    $query1= "select * from question where cid='5'";
    $query2="select * from qvalues";$query2="SELECT * FROM qvalues, question WHERE qvalues.question_id=question.question_id AND question.cid='5'";
